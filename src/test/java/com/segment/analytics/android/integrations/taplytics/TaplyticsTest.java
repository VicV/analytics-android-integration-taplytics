...
@Config(constants = BuildConfig.class, sdk = 21, manifest = Config.DEFAULT)
...
public class TaplyticsTest {
    ...
    public void activityCreate() {
        ...
        settings.put("turnMenu", false);
        settings.put("sessionMinutes", 10);
        settings.put("liveUpdate", true);
        settings.put("shakeMenu", true);
        settings.put("delayedStartTaplytics", true);
